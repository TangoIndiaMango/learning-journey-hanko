...
// we get the type from zod using the infer method
...
const CreateCourseForm = (props: Props) => {
    ...
    function onSubmit(data: Input) {
        ...
        createChapters(data, {
            //destructurre what the endpoint returns
            onSuccess: ({ course_id }) => {
                toast({
                    title: "Success",
        ...
        <div className="w-full">
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className='w-full mt-4'>
                    ...
                    {/* // this the elemnts we are adding thats why we animate  */}
                    <AnimatePresence>
                                        ...
                                        render={({ field }) => {
                                            return (
                                                <FormItem className='flex flex-col items-start w-full sm:items-center sm:flex-row'>
                                                    ...
                                                    <FormControl className='flex-[6]'>
                                                        <Input placeholder="Enter Sub topic of the course" {...field} />
                                                    </FormControl>
                                                </FormItem>
                                            )
                                        }}
